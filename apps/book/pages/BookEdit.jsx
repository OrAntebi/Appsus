...
export function BookEdit() {
    ...
    return (
        <section className="main-content">
            <section className="book-edit-container flex column">
                <h2>{bookId ? 'Edit Book' : 'Add Book'}</h2>

                <form className="book-edit-form flex column" onSubmit={onSave}>
                    ...
                    <label className="label flex align-center space-between" htmlFor="isOnSale">
                        On Sale:
